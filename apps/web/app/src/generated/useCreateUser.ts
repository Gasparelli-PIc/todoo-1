...
export const createUserMutationKey = () => [{ url: '/usuarios/' }] as const
...
export async function createUser(data: CreateUserMutationRequest, config: Partial<RequestConfig<CreateUserMutationRequest>> & { client?: typeof fetch } = {}) {
  ...
  const res = await request<CreateUserMutationResponse, ResponseErrorConfig<Error>, CreateUserMutationRequest>({ method : "POST", url : `/usuarios/`, data : requestData, ... requestConfig })  
  return res.data
}
